...
describe EnvironmentalDamageEvent do
  ...
  it "should have :prefix be an EnvironmentalTypePrefix" do
    @event.prefix.class.to_s.should == "EnvironmentalTypePrefix"
  end
  ...
  it "should delegate :environmental_type to :prefix" do
    @event.prefix.should_receive( :environmental_type )
    
    @event.environmental_type
  end
